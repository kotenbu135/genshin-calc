...
| 武器パッシブ (ConditionalBuff) | 220 | 14 | 206 | 6% |
...
P2で `BuffableStat::ElementalResReduction(Element)` と `PhysicalResReduction` を追加済み。
翠緑の影4pc・深林4pcに ConditionalBuff として定義済み。
Consumer側で ResolvedBuff の耐性減少値を Enemy.resistance に適用する実装が残タスク。

- [ ] Consumer側実装: ResolvedBuff の ElementalResReduction/PhysicalResReduction を Enemy.resistance に減算
- [ ] 超電導 — 物理耐性-40%
- [ ] Zhongli シールド — 全耐性-20%
- [ ] Chevreuse — 炎/雷耐性-40%
- [ ] Lisa A4 — DEF-15%
