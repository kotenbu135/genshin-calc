...
| Name | ID | 2pc | 4pc |
|------|----|-----|-----|
| Crimson Witch of Flames | crimson_witch | StatBuff | ConditionalBuff |
| Gladiator's Finale | gladiators_finale | StatBuff | ConditionalBuff |
| Wanderer's Troupe | wanderers_troupe | StatBuff | ConditionalBuff |
| Noblesse Oblige | noblesse_oblige | StatBuff | ConditionalBuff |
| Bloodstained Chivalry | bloodstained_chivalry | StatBuff | ConditionalBuff |
| Thundering Fury | thundering_fury | StatBuff | ConditionalBuff |
...
| Heart of Depth | heart_of_depth | StatBuff | ConditionalBuff |
| Tenacity of the Millelith | tenacity_of_the_millelith | StatBuff | ConditionalBuff |
| Pale Flame | pale_flame | StatBuff | ConditionalBuff |
| Shimenawa's Reminiscence | shimenawas_reminiscence | StatBuff | ConditionalBuff |
| Emblem of Severed Fate | emblem_of_severed_fate | StatBuff | ConditionalBuff |
...
| Flower of Paradise Lost | flower_of_paradise_lost | StatBuff | ConditionalBuff |
| Nymph's Dream | nymphs_dream | StatBuff | ConditionalBuff |
...
| Name | ID | Rarity | 2pc | 4pc |
|------|----|--------|-----|-----|
| Resolution of Sojourner | resolution_of_sojourner | 4&5 | StatBuff | ConditionalBuff |
| Tiny Miracle | tiny_miracle | 4&5 | StatBuff | DescriptionOnly |
| Berserker | berserker | 4 | StatBuff | ConditionalBuff |
| Instructor | instructor | 4 | StatBuff | ConditionalBuff |
| Exile | exile | 4 | StatBuff | DescriptionOnly |
| Martial Artist | martial_artist | 4 | StatBuff | ConditionalBuff |
| Defender's Will | defenders_will | 4 | StatBuff | DescriptionOnly |
| Brave Heart | brave_heart | 4 | StatBuff | ConditionalBuff |
| Gambler | gambler | 4 | StatBuff | DescriptionOnly |
| Scholar | scholar | 4 | StatBuff | DescriptionOnly |
| Prayers for Illumination | prayers_for_illumination | 4 | DescriptionOnly | DescriptionOnly |
| Prayers for Destiny | prayers_for_destiny | 4 | DescriptionOnly | DescriptionOnly |
| Prayers for Wisdom | prayers_for_wisdom | 4 | DescriptionOnly | DescriptionOnly |
| Prayers to Springtime | prayers_to_springtime | 4 | DescriptionOnly | DescriptionOnly |
