...
static RAIDEN_SHOGUN_BUFFS: &[TalentBuffDef] = &[
    ...
    TalentBuffDef {
        ...
        description: desc!("A4: Excess Energy Recharge above 100% grants Electro DMG Bonus"),
...
static BEIDOU_BUFFS: &[TalentBuffDef] = &[
    ...
    TalentBuffDef {
        ...
        description: desc!("A4: After max Tidecaller, Normal ATK DMG +15% for 10s"),
    ...
    TalentBuffDef {
        name: "Lightning Storm",
        description: desc!("A4: After max Tidecaller, Charged ATK DMG +15% for 10s"),
...
static CYNO_BUFFS: &[TalentBuffDef] = &[
    TalentBuffDef {
        ...
        description: desc!("A1: Endseer-empowered skill deals 35% increased DMG"),
...
static RAZOR_BUFFS: &[TalentBuffDef] = &[
    ...
    TalentBuffDef {
        name: "Bite",
        description: desc!("C4: Press Skill hit reduces enemy DEF by 15% for 7s"),
        stat: BuffableStat::DefReduction,
        base_value: 0.15,
        scales_with_talent: false,
        talent_scaling: None,
