...
// ===== Illuga =====
// A1 passive "Torchforger's Covenant": CRIT Rate +5%, CRIT DMG +10%, EM +50 (Moonsign)
//   source was wrongly listed as A4 — corrected to A1
// A4 passive "Demonhunter's Dusk": Geo DMG Bonus = EM × coefficient based on party Hydro/Geo count
//   1 member: EM×7%, 2 members: EM×14%, 3 members: EM×24%
//   Simplified: 2-member coefficient (14%) as representative; party count not modeled
// Burst "Shadowless Reflection": EM-based additive flat Burst DMG (per stack consumed), not talent%
//   TODO: Correct mechanic (EM×stack scaling) cannot be fully modeled in TalentBuffDef; omitted
...
static ILLUGA_BUFFS: &[TalentBuffDef] = &[
    ...
    TalentBuffDef {
        name: "Demonhunter's Dusk - Geo DMG (simplified 2-member)",
        description: "A4: Geo DMG Bonus = EM × 14% (simplified: 2 Hydro/Geo allies; actual: 7%/14%/24% for 1/2/3 members)",
        stat: BuffableStat::ElementalDmgBonus(Element::Geo),
        base_value: 0.14,
        scales_with_talent: false,
        talent_scaling: None,
