...
static NAHIDA_BUFFS: &[TalentBuffDef] = &[
    ...
    TalentBuffDef {
        name: "nahida_c4_em_base",
        description: desc!("C4: EM +80 constant base (always active at C4)"),
        stat: BuffableStat::ElementalMastery,
        base_value: 80.0,
        scales_with_talent: false,
        talent_scaling: None,
    ...
    TalentBuffDef {
        name: "nahida_c4_em_stacks",
        description: desc!(
            "C4: EM +20 per nearby Skandha enemy (max 4 stacks; total = 100/120/140/160)"
        ),
        stat: BuffableStat::ElementalMastery,
        base_value: 20.0,
        scales_with_talent: false,
